    ...
    <section className="text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto flex flex-wrap sm:flex-nowrap">
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <p className="leading-relaxed mb-5 text-gray-600">Please provide your feed back according to your satisfation and what do you want this site to make avilable..</p>
          ...
          <p className="text-xs text-gray-500 mt-3">Your provided data are being stored in securely.</p>
        </div>
      </div>
    </section>
  );
